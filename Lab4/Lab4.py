...
def planning_matrix_linear(n, m, x_range):               #матриця планування
...
def regression_equation(x, y, n):
    ...
    print('\nРівняння регресії:')
    print(f'y = {B[0]} + {B[1]}*x1 + {B[2]}*x2 + {B[3]}*x3')    #вивід рівняння регресії
...
if __name__ == '__main__':
    x_range = ((10, 50), (20, 60), (20, 25)) #значення за варіантом

    y_max = 200 + int(sum([x[1] for x in x_range]) / 3)  #розрахунок у
    y_min = 200 + int(sum([x[0] for x in x_range]) / 3)  #розрахунок у
